    ...
    return (
        <div className="w-full flex flex-col bg-slate-50" style={{ height: "var(--app-height)" }}>
            ...
            <div className="flex-1 min-h-0 overflow-y-auto">
                ...
                <div className="flex flex-col items-center py-6 bg-white border-b border-slate-200">
                    <div className="relative mb-3" ref={dpMenuRef}>
                        ...
                        <button
                            ...
                            className="absolute bottom-0 right-0 h-6 w-6 bg-violet-600 rounded-full flex items-center justify-center border-2 border-white"
                        >
                        ...
                        {dpMenuOpen && (
                            <div className="absolute top-18 right-0 bg-white border border-slate-200 rounded-xl shadow-lg z-20 overflow-hidden min-w-[155px]">
                                <button
                                    onClick={() => { fileInputRef.current?.click(); setDpMenuOpen(false); }}
                                    className="w-full text-left px-4 py-2.5 text-sm text-violet-700 hover:bg-violet-50 transition-colors"
                                >
                                    Change photo
                                </button>
                        ...
                        <div key={field} className="px-5 py-3 border-b border-slate-100 last:border-b-0">
                            ...
                            {editingField === field ? (
                                <div className="flex items-center gap-2">
                                    ...
                                    />
                                    <button onClick={handleEditSave} disabled={isUpdating} className="text-xs text-violet-600 font-medium">
                                        {isUpdating ? "..." : "Save"}
                                    </button>
                ...
                <div className="bg-white mt-2 border-y border-slate-200">
                    <button onClick={() => navigate("/profile/info")} className="w-full flex items-center justify-between px-5 py-3 border-b border-slate-100 hover:bg-slate-50">
                    ...
                    <button onClick={() => navigate("/profile/privacy")} className="w-full flex items-center justify-between px-5 py-3 border-b border-slate-100 hover:bg-slate-50">
                        <div className="flex items-center gap-3">
                            <div className="h-8 w-8 rounded-full bg-violet-100 flex items-center justify-center">
                    ...
                    <button onClick={() => navigate("/profile/blocked")} className="w-full flex items-center justify-between px-5 py-3 hover:bg-slate-50">
                        <div className="flex items-center gap-3">
